...
# variable NETWRKAPP_SETTINGS. Setting this environment variable is optional.
# Docs: http://flask.pocoo.org/docs/latest/config/
#
# EXAMPLE:
# $ export NETWRKAPP_SETTINGS=secret_key_config.py
app.config.from_envvar('NETWRKAPP_SETTINGS', silent=True)
